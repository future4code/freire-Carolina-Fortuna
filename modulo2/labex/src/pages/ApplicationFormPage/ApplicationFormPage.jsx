...
const [form, setForm]= useState({name: '', age: 0, applicationText:'', profession:'', country:'', trip:''})
...
const submitApplication = (id, event) =>{
...
const optionsTrip= trips.map((item)=>{
    return(
        <option value={item.id}>{item.name} - {item.planet}</option>
     )
      })
    ...
    return(
        <div>
            ...
            <ApplicationForm>
                ...
                <center>
                <form onSubmit={()=>submitApplication(form.trip)}>
                ...
                <br />
                <input type="text" 
                placeholder="Responda por que você é um(a) bom(a) candidato(a)" 
